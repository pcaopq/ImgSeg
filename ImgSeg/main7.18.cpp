...
//                }
//                case 6:{
//                    rectangle(imageBGR, Point(j.left*factorw, j.top*factorh), Point(j.right*factorw, j.bottom*factorh), CV_RGB(0, 0, 0), 10);
//                    break;
//                }
//                case 7:{
//                    rectangle(imageBGR, Point(j.left*factorw, j.top*factorh), Point(j.right*factorw, j.bottom*factorh), CV_RGB(0, 0, 0), 10);
...
//     threshold(image_ori, image, 10, 255.0, THRESH_BINARY);
...
//     deletesmallarea(titleblocks, 500);
...
//       Draw(lines, false, imgname+"titleblks2", original_height/3200, original_width/2300);
     return 0;
 }
