...
template<typename T>
void createXML(vector<T> patterns, const char* name, float factorh, float factorw){
    ...
    Page->SetAttribute("HEIGHT", height*factorh);
    Page->SetAttribute("WIDTH", width*factorw);
    ...
    for(auto i:patterns){
        ...
        String->SetAttribute("HEIGHT", (i.bottom - i.top)*factorh);
        String->SetAttribute("WIDTH", (i.right - i.left)*factorw);
        String->SetAttribute("CONTENT", "HELLO");
        String->SetAttribute("HPOS", i.left*factorw);
        String->SetAttribute("VPOS", i.top*factorh);
...
void changeblocktype(vector<block>& A, vector<block>& B, int C){
    int Btype = B[0].type;
...
//        if(!exist){
//            for(auto i:blks){
//                if(i.top == A.top && i.bottom == A.bottom && i.left == A.left && i.right == A.right)
//                    continue;
//                if(i.top == B.top && i.bottom == B.bottom && i.left == B.left && i.right == B.right)
//                    continue;
//                if(i.width + r - l >= max(i.right, r) - min(i.left, l)){
//                    if((A.bottom > i.top && B.top < i.bottom) || (B.bottom > i.top && A.top < i.bottom)){
//                        exist = true;
...
//       saveInfo(lines, imgname+"lines.txt");
//       saveInfo(graph, imgname+"graph.txt");
//       saveInfo(patterns, imgname+"patterns.txt");
...
//     readInfo(lines, imgname+"lines.txt");
//     vector<pattern> graph;
//     readInfo(graph, imgname+"graph.txt");
//     vector<pattern> patterns;
//     readInfo(patterns, imgname+"patterns.txt");
...
//     createXML(patterns, "0253.xml", original_height/3200, original_width/2300);
...
//     deletesmallarea(textblocks, 20000);
//     cleanregion2(textblocks, graph, 10);
...
//     changeblocktype(textblocks, titleblocks, 5000);
     cleanregion2(titleblocks, textblocks, 10); //clean title blocks in textblocks
//     cleanregion2(titleblocks, graph, 10);
//     cleanonenearanother(titleblocks, textblocks, 10, 10000, 1);
     merge_blocks(titleblocks, 10, 10, textblocks, lines);
//     deletesmallarea(textblocks, 1000);
...
//         cleanonenearanother(textblocks, titleblocks, 0, 1000, 1);
         cout<<"first"<<endl;
     }
...
//     check_num_patterns(textblocks, titleblocks, patterns);
//     cleanregion(textblocks, 10);
//     deletesmallarea(textblocks, 1000);
//     changeblocktype(textblocks, titleblocks, 5000);
//
//     while(bs != textblocks.size() || ps != titleblocks.size()){
//         bs = textblocks.size();
//         ps = titleblocks.size();
//         merge_blocks(textblocks, 10, 10, titleblocks, lines);
//         merge_blocks(titleblocks, 100, 100, textblocks, lines);
//         cleanonenearanother(textblocks, titleblocks, 20, 20000, 2);
//         cleanonenearanother(titleblocks, textblocks, 20, 20000, 2);
//         cout<<"second"<<endl;
//     }
     
//     deletesmallarea(titleblocks, 1000);
//     deletesmallarea(textblocks, 1000);
     
//     formetablk(titleblocks, textblocks, lines);
     for(auto i:titleblocks)
         textblocks.push_back(i);
//     Draw(graph, false, imgname+"txtblks", original_height/3200, original_width/2300);
     ...
     Draw(textblocks, false, imgname+"txtblks", original_height/3200, original_width/2300);//false: do not print the blocks info
//          Draw(textblocks, false, imgname+"txtblks", 1, 1);//false: do not print the blocks info
//       Draw(titleblocks, false, imgname+"titleblks2");
//     Draw(lines, false, imgname+"lines", original_height/3200, original_width/2300);
     return 0;
 }
//The real running time in total is: 673.811s
//The real running time in total is: 448.635s